...
function getPhase(a,en){const c=(a+360)%360;if(c>135&&c<=225)return{icon:"🌙",name:en?"NIGHT":"NOCHE",help:en?"The astronaut is on the dark side":"El astronauta está en la zona oscura",sky:"linear-gradient(#020617,#172554)",skyIcon:"✨"};if(c>225&&c<=285)return{icon:"🌅",name:en?"SUNRISE":"AMANECER",help:en?"The planet turns into the light":"El planeta gira hacia la luz",sky:"linear-gradient(#7c3aed,#fb923c)",skyIcon:"🌅"};if(c>285||c<=75)return{icon:"☀️",name:en?"DAY":"DÍA",help:en?"The astronaut faces the Sun":"El astronauta está de cara al Sol",sky:"linear-gradient(#38bdf8,#dbeafe)",skyIcon:"☀️"};return{icon:"🌇",name:en?"SUNSET":"ATARDECER",help:en?"The planet turns away from the light":"El planeta gira hacia la oscuridad",sky:"linear-gradient(#2563eb,#f97316)",skyIcon:"🌇"}}
